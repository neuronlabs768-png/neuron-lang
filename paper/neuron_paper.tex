...
\begin{itemize}[itemsep=2pt]
  ...
  \item \textbf{Not yet implemented}: GPU backend, cross-module type inference (imported symbols currently receive type \ty{Any}), formal soundness proof.
\end{itemize}
...
\textbf{Future work.} Offset-based temporal types (\S\ref{sec:temporal}), cross-module type inference, GPU backend, and formal soundness proof.
