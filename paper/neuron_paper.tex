...
\midrule
MatMul (200x) & NEURON VM (Interpreted) & 1 & 8,837.73 \\
& NEURON Native JIT & 1 & 445.77 \\
& PyTorch CPU (1 Thread) & 1 & 218.23 \\
& Python + NumPy (f64) & Multi & 162.29 \\
& PyTorch CPU (Multi-Thread) & Multi & 71.90 \\
\midrule
MLP Backprop (100 steps) & NEURON VM (Interpreted) & 1 & 307.57 \\
& NEURON Native JIT & 1 & 228.53 \\
& PyTorch CPU (1 Thread) & 1 & 195.57 \\
& PyTorch CPU (Multi-Thread) & Multi & 215.07 \\
\bottomrule
\end{tabular}
\end{table}
